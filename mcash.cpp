...
void MyCash ::history()
{
    ...
    for (int i = 0; i < cnt; i++)
    {
        ...
        cout << fixed << setprecision(2) << setw(10) << get<0>(hist[i]) << setw(10) << get<1>(hist[i]) << get<2>(hist[i])
             << endl;
    }
    cout << "Press any key go to main menu....." << endl;
    getch();
...
int main_menu()
{
    ...
    cout << "\t\t7. Check Account Balance" << endl;
    cout << "\t\t8. History" << endl;
    cout << "\t\t9. Logout" << endl;
    cout << "Choose Your Option (1-9): ";
    int s;
    cin >> s;
    system("cls");
    return s;
